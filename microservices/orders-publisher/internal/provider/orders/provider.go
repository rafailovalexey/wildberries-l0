...
import (
	...
	orderController "github.com/emptyhopes/orders-publisher/internal/controller/orders"
	defenition "github.com/emptyhopes/orders-publisher/internal/provider"
	"github.com/emptyhopes/orders-publisher/internal/repository"
	orderRepository "github.com/emptyhopes/orders-publisher/internal/repository/orders"
	"github.com/emptyhopes/orders-publisher/internal/service"
	orderService "github.com/emptyhopes/orders-publisher/internal/service/orders"
)
