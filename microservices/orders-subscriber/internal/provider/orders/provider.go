...
import (
	...
	orderController "github.com/emptyhopes/orders-subscriber/internal/controller/orders"
	"github.com/emptyhopes/orders-subscriber/internal/converter"
	orderConverter "github.com/emptyhopes/orders-subscriber/internal/converter/orders"
	defenition "github.com/emptyhopes/orders-subscriber/internal/provider"
	"github.com/emptyhopes/orders-subscriber/internal/repository"
	orderRepository "github.com/emptyhopes/orders-subscriber/internal/repository/orders"
	"github.com/emptyhopes/orders-subscriber/internal/service"
	orderService "github.com/emptyhopes/orders-subscriber/internal/service/orders"
